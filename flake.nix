    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in {
        devShell = pkgs.mkShell {
          ...
          GHC_DOCS_ROOT =
            builtins.trace (builtins.toString (builtins.attrNames (haskell-nixpkgs-fixes.packages."${system}".ghcs.ghc9141-base)))
              builtins.trace (builtins.toString (builtins.attrNames ghc))
              "${ghc.doc}/share/doc/ghc-native-bignum/html/libraries";
